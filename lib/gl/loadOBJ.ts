import { Textures, Geometry, Materials, Mesh, UnpackedGeometry, BoundingBox, Vector3, PartialFace, Face, OBJData } from '../../types';
...
export const loadOBJWithoutWorker = ({ OBJSource, MTLSource, textures }: OBJData) => {
	const geometry: Geometry = loadOBJData(OBJSource);
	const materials: Materials = MTLSource && loadMTLData(MTLSource, textures);
