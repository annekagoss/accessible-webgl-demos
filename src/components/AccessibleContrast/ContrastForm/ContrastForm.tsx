...
const ControlForm = ({updateUniform}: Props) => {
	...
	const [color1, setColor1] = useState<RGB>({r: 0, g: 127, b: 255});
	const [color2, setColor2] = useState<RGB>({r: 127, g: 0, b: 255});
	const [color3, setColor3] = useState<RGB>({r: 255, g: 0, b: 127});
